...
class CandidateViewController: UIViewController, UINavigationControllerDelegate, UIImagePickerControllerDelegate, UIPopoverPresentationControllerDelegate, UITableViewDelegate, UITableViewDataSource,MFMailComposeViewControllerDelegate,UISearchBarDelegate  {
    ...
    // MARK: - UI Helper
    func imagePickerController(picker: UIImagePickerController, didFinishPickingImage image: UIImage!, ditingInfo: [NSObject : AnyObject]!) {
        println("--didFinishPickingImage -- CandidateViewController")
    ...
    func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        println("--cellForRowAtIndexPath -- CandidateViewController")
            ...
            if let picture = candidate.photo {
                ...
                println("Terminate CandidateCell")
            return cell
            
        } else if (tableView == self.tableViewRecruitment)  { // tableView == self.secondTableView
    ...
    func tableView(tableView: UITableView, didSelectRowAtIndexPath indexPath: NSIndexPath) {
        ...
        else
        {
            ...
            textAreaDegree.text = detailFull
        }
